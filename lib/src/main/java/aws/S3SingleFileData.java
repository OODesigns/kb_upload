...
public class S3SingleFileData implements Retrievable<S3Event, Optional<String>> {
    public static final int FIRST_ITEM = 0;
    private final String expectedFileName;
    private final Supplier<AmazonS3> amazonS3;

    public S3SingleFileData(final String expectedFileName, final Supplier<AmazonS3> amazonS3) {
