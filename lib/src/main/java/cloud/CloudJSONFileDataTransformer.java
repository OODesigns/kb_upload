...
public class CloudJSONFileDataTransformer implements CloudObjectToJSON {
    ...
    private final CloudStreamLoader<String> cloudStreamLoader;

    public CloudJSONFileDataTransformer(final CloudStreamLoader<String> cloudStreamLoader) {
        this.cloudStreamLoader = cloudStreamLoader;
    }
    ...
    private Optional<String> getData(final CloudObjectReference cloudObjectReference) {
        return cloudStreamLoader.retrieve(cloudObjectReference, this::getString);
    }
